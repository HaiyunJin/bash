...
# Updated: 2015/07/24 Haiyun Jin
# Updated: 2015/08/03 Haiyun Jin
#
...
if [ "$arg" == "-h" ] ; then
    echo "Usage:"
    echo "  qhost [-a] [-h]"
    echo "  -a : show opportunity nodes as well"
...
oppo8="compute-0-1 compute-0-2  compute-0-3  compute-0-4  compute-0-5  compute-0-6  compute-0-7  compute-0-8  compute-0-9  compute-0-10 compute-0-11 compute-0-12 compute-0-13 compute-0-14 compute-0-15 compute-0-30 compute-0-31 compute-0-32 compute-0-33 compute-0-34 compute-0-35 "
oppo12="compute-0-36 compute-0-37 compute-0-38 compute-0-39 compute-0-40 compute-0-41 compute-0-42 compute-0-43 compute-0-44 compute-0-45 compute-1-38 compute-1-39 compute-2-30 compute-2-31 compute-2-32 compute-2-33 compute-2-34 compute-2-35 compute-2-36 compute-2-37 compute-1-53 compute-2-50 compute-2-51 compute-2-52 compute-2-53"

...
arun8="compute-0-30"
arun12="compute-1-53 compute-2-50 compute-2-51 compute-2-52 compute-2-53"
...
#    if [ "$USER" == "cson"  ] ; then   # If a user is in arun's group, show arunnodes
title=' Arun Machine  ' ; write_title ;
    list=$arun8       ; mem="unknown"  ; np=8 ; proceed ;
    list=$arun12      ; mem="unknown"  ; np=12 ; proceed ;
#    elif [ "$arg" == "-a"  ]  ; then        # else , just add it to opportunity queue
#        oppo8="$oppo8 $arun8"
#        oppo12="$oppo12 $arun12"
#    fi
